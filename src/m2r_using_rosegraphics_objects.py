...
#            Draws everything that's attached in the window.
#
#     g. When is a RoseWindow close_on_mouse_click method call
#        necessary?  Why?
#            At the end of the code because if it wasn't at the end it might close before all actions are done.
#
